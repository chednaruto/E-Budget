...
public class SelectionMethodResult {
    ...
    public boolean InsertSelectionMethodResult(SelectionMethodResult sr) {
        boolean ret = false;
        try {
            DB2Manager dbms = new DB2Manager();
            String query = "SELECT * FROM e_budget.selection_method_result WHERE project_id='" + sr.getProject_id() + "'";
            ResultSet rs = dbms.GetDataAsResultSet(query);
            if (rs.next()) {
                query = "UPDATE e_budget.selection_method_result SET "
                ...
                query = "INSERT INTO e_budget.selection_method_result(project_id,invitation_announcement_step1_date,invitation_announcement_step2_date,"
