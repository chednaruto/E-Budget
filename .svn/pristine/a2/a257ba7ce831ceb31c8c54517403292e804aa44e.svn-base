            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12 center">
                        <button class="btn btn-success btn-white" style="float:right;" onclick="Goto('RDGoalAdd')"><i class="ace-icon fa fa-plus"></i> เพิ่มข้อมูล </button> 
                    </div>
                </div>
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="center" style="width:40%;"> ยุทธศาสตร์กรมสรรพากร </th>
                        ...
                        <tbody>
                            <%
                                ...
                                String query = "SELECT rg.*,rs.rd_strategic_name FROM e_budget.rd_goal rg LEFT JOIN e_budget.rd_strategic rs ON rg.rd_strategic_id = rs.rd_strategic_id";
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li> 
                                                <a href="#" onclick="Goto('RDGoalAdd&rd_goal_id=<%=acc.IsNullToEmtyString(rs.getString("rd_goal_id"))%>')"> 
                                                    <i class="fa fa-pencil-square-o blue"></i> แก้ไขรายการ </a> 
                                            </li>
                                            <%
                                                RdGoal rg = new RdGoal();
                                                rg.setRd_goal_id(acc.IsNullToEmtyString(rs.getString("rd_goal_id")));
                                                if (rg.CheckingUsage(rg)) {
                                            %>
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#" onclick="DEL('<%=acc.IsNullToEmtyString(rs.getString("rd_goal_id"))%>')"> 
