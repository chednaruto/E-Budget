            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12 center">
                        <button class="btn btn-success btn-white" style="float:right;" onclick="Goto('MofStrategicAdd')"><i class="ace-icon fa fa-plus"></i> เพิ่มข้อมูล </button> 
                    </div>
                </div>
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="center" style="width:70%;"> ยุทธศาสตร์กระทวงการคลัง </th>
                                <th class="center"> สถานะ </th>
                            </tr>
                        </thead>  
                        <tbody>
                            <%
                                String query = "SELECT * FROM e_budget.mof_strategic";
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li> 
                                                <a href="#" onclick="Goto('MofStrategicAdd&mof_strategic_id=<%=acc.IsNullToEmtyString(rs.getString("mof_strategic_id"))%>')"> 
                                                    <i class="fa fa-pencil-square-o blue"></i> แก้ไขรายการ </a> 
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#" onclick="DEL('<%=acc.IsNullToEmtyString(rs.getString("mof_strategic_id"))%>')"> 
                                                    <i class="ace-icon fa fa-trash red"></i> ลบรายการ </a> 
                                            </li>
                                        </ul>
                                    </div>
                                </td>
                                <td class="left"><%=acc.IsNullToEmtyString(rs.getString("mof_strategic_name"))%></td>
                                <td class="center">
                                    <%
                                        if (acc.IsNullToEmtyString(rs.getString("mof_strategic_status")).equals("Y")) {
