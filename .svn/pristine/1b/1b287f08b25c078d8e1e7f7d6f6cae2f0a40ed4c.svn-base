...
<div class="main-content-inner">
            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12 center">
                        <button class="btn btn-success btn-white" style="float:right;" onclick="Goto('ProjectRiskAdding&project_id=<%=request.getParameter("project_id")%>')"><i class="ace-icon fa fa-plus"></i> เพิ่มความเสี่ยง </button>
                    </div>
                </div>
                ...
                <div>
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th class="center" style="width: 150px;"> เมนู </th>
                                <th class="center"> ความเสี่ยง </th>
                            </tr>
                        </thead>  
                        <tbody>
                            <%
                                query = "select * from e_budget.project_risk where project_id= '" + request.getParameter("project_id") + "'";
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li> <a href="index.jsp?service=ProjectRiskAdding&project_id=<%=request.getParameter("project_id")%>&project_risk_id=<%=rs.getString("project_risk_id")%>"> <i class="fa fa-pencil-square-o blue"></i> แก้ไขกิจกรรม </a> </li>
                                            <li class="divider"></li>
                                            <li><a onclick="Delete(<%=rs.getString("project_risk_id")%>);"> <i class="ace-icon fa fa-trash red"></i> ลบกิจกรรม </a> </li>
                                        </ul>
                                    </div>
                                </td>
                                <td class="left"><%=rs.getString("project_risk_name")%></td>
                            </tr> 
                            <%
                                }
                                rs.close();
    ...
    <script>
                                                ...
                                                function Delete(project_risk_id) {
