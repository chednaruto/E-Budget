        ...
        try {
            ...
            if (!rs.next()) {
                ...
                query = "UPDATE e_budget.e_bidding_result "
                        ...
                        + "promise_number='" + er.getPromise_number() + "', "
                        + "promise_name='" + er.getPromise_name() + "' "
