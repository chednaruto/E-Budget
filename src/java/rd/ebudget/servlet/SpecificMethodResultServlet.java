...
import rd.ebudget.object.Budget.SpecificMethodResult;
import rd.ebudget.tools.Accessories;

public class SpecificMethodResultServlet extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           Accessories acc = new Accessories();
            ...
            if(method.equals("INSERT")){
                ...
                ret = smr.InsertSpecificMethodResult(smr);
            }
            if(ret){
                out.write("TRUE");
            }else{
