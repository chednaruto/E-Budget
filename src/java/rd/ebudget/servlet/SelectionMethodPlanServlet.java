...
import rd.ebudget.object.Budget.SelectionMethodPlan;
import rd.ebudget.tools.Accessories;


public class SelectionMethodPlanServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(method.equals("INSERT")){
                ...
                ret = sp.InsertSelectionMethodPlan(sp);
            }else if(method.equals("DELETE")){
                SelectionMethodPlan sp = new SelectionMethodPlan();
                sp.setProject_id(request.getParameter("selection_method_plan[project_id]"));
                ret = sp.DeleteSelectionMethodPlan(sp);
