            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12 center">
                        <button class="btn btn-success btn-white" style="float:right;" onclick="Goto('BudgetTypeAdding')"><i class="ace-icon fa fa-plus"></i> เพิ่มข้อมูล </button> 
                    </div>
                </div>
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="center" style="width:70%;"> ประเภทงบประมาณ </th>
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li> 
                                                <a href="#" onclick="Goto('BudgetTypeAdding&budget_type_id=<%=acc.IsNullToEmtyString(rs.getString("budget_type_id"))%>')"> 
                                                    <i class="fa fa-pencil-square-o blue"></i> แก้ไขรายการ </a> 
                                            </li>
                                            <%
                                                BudgetType btc = new BudgetType();
                                                btc.setBudget_type_id(acc.IsNullToEmtyString(rs.getString("budget_type_id")));
                                                if (btc.CheckingUsage(btc)) {
                                            %>
                                            <li class="divider"></li>
                                            <li>
                                                <a href="#" onclick="DEL('<%=acc.IsNullToEmtyString(rs.getString("budget_type_id"))%>')"> 
