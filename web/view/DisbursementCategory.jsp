                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="center" style="width:20%;"> ประเภทงบประมาณ </th>
                                <th class="center" style="width:20%;"> หมวดงบประมาณ </th>
                        ...
                        <tbody>
                            <%
                                ...
                                String query = "SELECT dc.*,dt.budget_category_name,dt.budget_type_id,bt.budget_type_name "
                                        ...
                                        + "LEFT JOIN e_budget.budget_type bt ON dt.budget_type_id = bt.budget_type_id";
